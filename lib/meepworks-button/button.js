...
var _meepButton = module.exports = core.createClass({
    ...
    render: function ()
    {
        ...
        var button;
        var params = [props].concat(label.map(function (item)
        {
            return item;
        }));
        if (this.props.tooltip)
        {
            params.push( meepTip.attach.call(this));
        }
        if (this.props.disabled !== true)
        {
            ...
            if (this.props.link)
            {
                ...
                /* Instead of passing in label as children array,
                    ...
                    using unique keys
                */
                return dom.a.apply(this, params);
            }
            else
            {
                return dom.button.apply(this, params);
            }
        }
        else
        {
